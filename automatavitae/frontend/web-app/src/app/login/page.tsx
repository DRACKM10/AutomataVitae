        ...
        >
          ...
          <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-[#09090b] hover:bg-gray-50 dark:hover:bg-gray-900 text-sm font-medium text-gray-700 dark:text-gray-300 transition-all shadow-sm mt-3"
            >
